    ...
    return (
        <div id="dashboard-container">
            <PageHeader title="Dashboard" breadcrumb="Home / Dashboard">
                <button className="bg-hijau text-white px-4 py-2 rounded-lg mr-2">Add</button>
                <button className="bg-biru text-white px-4 py-2 rounded-lg mr-2">Export</button>
                <button className="bg-kuning text-white px-4 py-2 rounded-lg mr-2">Kembali</button>
            </PageHeader>
